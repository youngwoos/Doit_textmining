...
include_graphics("../../Quiz/Quiz_Part05_files/figure-markdown_github/unnamed-chunk-15-1.png")
```
...
```{r, echo=F, out.width="90%"}
include_graphics("../../Quiz/Quiz_Part05_files/figure-markdown_github/unnamed-chunk-17-1.png")
```
